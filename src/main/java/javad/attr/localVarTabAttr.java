 ...
 * @author Ian Kaplan
 */
class localVarTabAttr extends Attribute {
    ...
    class localVarEnt {
        ...
        localVarEnt(DataInputStream dStream, ConstPool constPoolSec) {
            ...
            length = readUnsignedShort(dStream);
    ...
    localVarTabAttr(String name, int length,
        ...
        super(name, length);
        int numVarEnt = readUnsignedShort(dStream);
    ...
    public Vector getLocalVarVec() {
        ...
        if (localVarTab != null) {
            for (localVarTabAttr.localVarEnt localVarEnt : localVarTab) {
                if (localVarVec == null)
                    localVarVec = new Vector();

                localDecl = localVarEnt.getLocalVarDecl();
